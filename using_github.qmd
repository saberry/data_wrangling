...
The easiest way to do this on a Mac is to install the gh set of binaries and use them to authenticate.  You can do so using the following steps:
```
# Install gh
brew install gh
...
# Authenitcate to github.com, specifying HTTPS, authenticating git, and Login with Browser option
```

## Windows
If you are on Windows, open Git Bash (or the command prompt if you are having trouble finding the Bash terminal). Remember that you can use the terminal that comes packaged in RStudio, but any terminal will do.
...
6. Whenever you are prompted for a password, enter your PAT, not your actual password.
